  ...
  if (!item) {
    ...
    return (
      <div>
        ...
        <div className="bg-white rounded-2xl lg:mx-[5%] mx-[2%] overflow-hidden my-20 shadow-2xl shadow-gray-100 border border-gray-100 hover:shadow-3xl hover:shadow-gray-200 transition-all duration-300">
