...
const Footer = () => {
  ...
  >
    ...
    <div>
      ...
      <footer
        className={`relative overflow-hidden bg-white border-t border-gray-200 ${font.className}`}
      >
        <img
          src="/oh.png"
          alt=""
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div>
              ...
              <div className="mb-5">
                ...
                <div className="w-10 h-1 bg-[var(--orange-color)] rounded-full mt-2" />
              </div>
